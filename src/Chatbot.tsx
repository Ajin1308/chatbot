...
export default function Chatbot({ position, apiUrl, theme, boticon, chatboticon }: ChatbotProps) {
  ...
  return (
    <>
      ...
      {!isOpen && showInviteMessage && (
        <div className="bg-transparent p-4 animate-fadeIn"
        style={{
          ...getInviteMessagePosition()
        } as React.CSSProperties}>
          <div className="flex justify-between items-center mb-2 bg-white rounded-lg shadow-xl p-4 gap-3 border border-black">
            <h3 className="m-0 text-md font-medium">Hi! What are you looking for?</h3>
              <button 
                className="bg-transparent border-none cursor-pointer text-xl p-0 text-gray-500 leading-none"
          ...
          <div className="flex gap-3">
            ...
            <button 
              ...
              className="flex items-center px-4 py-2 bg-[#fff5f0] border border-black rounded-full shadow-xl cursor-pointer font-medium text-sm text-left"
            >
              <Search size={20} className="mr-2" color="black" />
              Find a product
            </button>
            ...
            <button 
              ...
              className="flex items-center px-4 py-2 bg-[#fff5f0] border border-black rounded-full shadow-xl cursor-pointer font-medium text-sm text-left"
            >
              <HelpCircle size={20} className="mr-2" color="black" />
              Ask a question
            </button>
          </div>
      ...
      <div style={styles.chatWindow(isOpen, isMaximized, theme, getPositionStyle)} className="chat-window">
        {/* Top Bar */}
        <div className="h-[50px] bg-primary flex items-center justify-between px-3 rounded-t-lg">
            {/* Chat Title */}
            <span className="text-secondary text-[16px] font-bold">
            SmartShop AI
            </span>
            ...
            >
                <img src="/refresh.png" alt="Maximize/Minimize" className="w-[20px] h-[20px]" />
            </button>
            ...
            >
                <img src="/zoom.png" alt="Maximize/Minimize" className="w-[22px] h-[22px]" />
            </button>
            ...
            <button
                ...
                onClick={toggleChat}
            >
                <XIcon size={24} className="text-secondary" />
            </button>
            </div>
        </div>
